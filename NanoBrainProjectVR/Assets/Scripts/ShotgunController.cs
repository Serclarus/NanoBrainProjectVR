...
public class ShotgunController : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            // We are setting this to false per user request, so the weapon becomes a true child of the hand/socket.
            // If AutoObjectParentSync is enabled on the NetworkObject, NGO might throw invalid parent warnings.
