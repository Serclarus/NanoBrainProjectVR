...
{
    // Call this from a UI Button or XR Simple Interactable to Host a game using Unity Relay (Works on LAN & Internet)
    ...
    // Call this from a UI Button or XR Simple Interactable to Join the first available game using Unity Relay
    ...
    // Call this to host a strictly offline LAN server. Uses local IP address.
    ...
    // Call this to join a strictly offline LAN server. (Requires typing the Host's IP address in UnityTransport first!)
