...
namespace XRMultiplayer
{
    ...
    public class JointBasedHand : MonoBehaviour
    {
        ...
        {
            m_CurrentPlatformIndex = (int)XRPlatformType.AndroidXR; // Assuming the hand root for AXR is the same as this object
            ClearHandReferences();
            SetupHandReferences();
        }
        ...
        {
            m_CurrentPlatformIndex = (int)XRPlatformType.Quest; // Assuming the hand root for Quest is the same as this object
            ClearHandReferences();
            SetupHandReferences();
        }
